...
// Expor o QR Code via Socket.IO
client.on("qr", qr => {
    io.emit("whatsapp_qr", qr);
});

// Enviar evento quando conectar
client.on("ready", () => {
    io.emit("whatsapp_ready");
});

// Ouvir o botão do painel administrativo
...
client.on('message', async msg => {
    ...
    if (msg.body.match(/(menu|Menu|dia|tarde|noite|oi|Oi|Olá|olá|ola|Ola)/i) && msg.from.endsWith('@c.us')) {
        ...
        await client.sendMessage(msg.from,'Olá! '+ name.split(" ")[0] + '. Sou o assistente virtual da empresa Marthec. Como posso ajudá-lo hoje? Por favor, digite uma das opções abaixo:\n\n1 - Como funciona?\n\n2 - Valores dos planos para ter uma idéia\n\n3 - Quero um orçamento\n\n4 - Como aderir?\n\n5 - Falar com atendente'); //Primeira mensagem de texto
        //await delay(3000); //delay de 3 segundos
        //await chat.sendStateTyping(); // Simulando Digitação
    ...
    if (msg.body !== null && msg.body === '1' && msg.from.endsWith('@c.us')) {
        ...
        await chat.sendStateTyping(); // Simulando Digitação
        await delay(3000);
        await client.sendMessage(msg.from, 'Link para cadastro: https://www.marthec.com.br');
